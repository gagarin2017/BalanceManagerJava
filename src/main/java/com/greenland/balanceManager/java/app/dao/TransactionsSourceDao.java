...
public interface TransactionsSourceDao {
	...
	/**
	 * Populates the transactions from the files specified in properties file.
	 * 
	...
	void populateTxMapsFromSource(Map<LocalDate, List<TxDataRow>> remoteTransactionMap,
			Map<LocalDate, List<TxDataRow>> localTransactionMap) throws TransactionsNotFoundAtSourceException;
